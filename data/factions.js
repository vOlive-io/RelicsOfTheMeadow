...
const factions = [
  ...
  },
  {
    ...
    defaultTraits: { prowess: "5/10", resilience: "5/10", economy: "5/10" },
    relationships: {
      "Devoured Faith": "neutral",
      "Spider Court": "neutral",
  ...
  },
  {
    ...
    defaultTraits: { prowess: "5/10", resilience: "9/10", economy: "1/10" },
    relationships: {
      "Devoured Faith": "neutral",
      "Spider Court": "neutral",
      "Meadowfolk Union": "neutral",
  ...
  },
  {
    ...
    emoji: "🕸️",
    overview: "Every secret is a thread—and the Silken Dominion spins them all.",
    fullLore:
      "Hidden deep within the shadowed caverns and hollowed ruins of their lost empire, the Silken Dominion plots its silent return. Once the rulers of the known world, they were cast into hiding after the fall of the old age. But the Dominion has waited, patient as silk—watching the world rebuild and fracture, biding their time until the moment to reclaim their dominion arrived. They do not seek vengeance; they seek restoration. The world has changed, and the Dominion intends to change with it—but never beneath it.\n\nThe Silken Dominion is a sprawling bureaucracy of schemers and manipulators bound by old law. They feed not on blood, but on information, weaving deception into law and lies into treaties. They twist negotiations, alter alliances, and sabotage conflicts, all without ever drawing a blade. Their trade in goods and influence flows easily, for while they produce much, they rely on others—chiefly the Jade Empire—to distribute their wares. Together, they maintain a fragile but lucrative dance of dependence. Yet all the while, the Dominion gathers secrets like flies, waiting for the perfect time to strike.\n\nIn gameplay, their power of manipulation is immense—but it comes at a cost. Maintaining their intricate network of espionage and diplomacy slowly drains their economy, forcing players to balance deceit with sustainability. Their grudges run deep, and when they turn their focus toward an enemy, they can rally the entire board against them—not through might, but through quiet, ruthless persuasion.",
    specialMechanic: {},
