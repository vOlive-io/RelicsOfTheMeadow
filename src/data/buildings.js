export const buildingDefinitions = [
  ...
  //cottage
  {
    ...
    icon: "🏡",
    beds: 10,
    cost: { logs: 50, stone: 50, mythril: 25, goldCoins: 15 },
    blueprintTier: "default",
  },
  //villa
  {
    ...
    icon: "🏡",
    beds: 25,
    cost: { logs: 150, stone: 100, mythril: 50, goldCoins: 25, silktoneObsidian: 10 },
    blueprintTier: "default",
  },
  //longhouse
  {
    ...
    icon: "🏘️",
    beds: 50,
    cost: { logs: 300, stone: 200, mythril: 100, goldCoins: 50, silktoneObsidian: 25 },
  ...
  //holdstead
  {
    ...
    icon: "🏛️",
    beds: 100,
    cost: { logs: 100, stone: 500, mythril: 250, goldCoins: 150, silktoneObsidian: 100, lumenQuartz: 50, magicalEssence: 50 },
  ...
  //grand holdstead
  {
    ...
    icon: "🏛️",
    beds: 250,
    cost: { logs: 1500, stone: 1000, mythril: 500, goldCoins: 500, silktoneObsidian: 200, lumenQuartz: 200, magicalEssence: 100, starpetalOre: 20 },
    upkeep: { logs: 10, mythril: 2 },
    blueprintTier: "apex",
  },
  ///////////////////////
  ...
  // Basic Orchard
  {
    ...
    icon: "🍎",
    produces: { fruits: 8 },
    cost: { logs: 80, stone: 80, clay: 40, goldCoins: 10 },
  ...
  // Orchard of the Gods
  {
    ...
    type: "production",
    icon: "🍇",
    produces: { fruits: 40, logs: 18, nectarSap: 6 },
    cost: { logs: 120, clay: 30, goldCoins: 6, meadowheartOpal: 3 },
    supportedTerrains: ["Meadow", "Forest", "Ancient Grove"],
    blueprintTier: "apex",
  ...
  // Farm of the Gods
  {
    ...
    type: "production",
    icon: "🌾",
    produces: { wheat: 40, fruits: 12, spices: 4 },
    cost: { logs: 120, stone: 40, goldCoins: 4, meadowheartOpal: 3 },
    supportedTerrains: ["Meadow", "River", "Ancient Grove"],
    blueprintTier: "apex",
  ...
  // Herb Garden of the Gods
  {
    ...
    type: "production",
    icon: "🌺",
    produces: { herbs: 30, spices: 12, magicalEssence: 2 },
    cost: { logs: 90, stone: 30, goldCoins: 3, meadowheartOpal: 3 },
    supportedTerrains: ["Meadow", "Forest", "Ancient Grove"],
    blueprintTier: "apex",
  ...
  // Pasture of the Gods
  {
    ...
    type: "production",
    icon: "🦬",
    produces: { meat: 30, wheat: 12, leather: 4 },
    cost: { logs: 130, stone: 60, mythril: 2, goldCoins: 4 },
    supportedTerrains: ["Meadow", "Hills"],
    blueprintTier: "apex",
  ...
  // Mortar Quarry of the Gods
  {
    ...
    type: "production",
    icon: "🧱",
    produces: { clay: 75, stone: 30, lumenQuartz: 3 },
    cost: { logs: 180, stone: 260, mythril: 6, clay: 100, goldCoins: 6 },
    supportedTerrains: ["Hills", "River"],
    blueprintTier: "apex",
  ...
  // Sawmill of the Gods
  {
    ...
    type: "production",
    icon: "🪵",
    produces: { logs: 125, timber: 30, resin: 6 },
    cost: { logs: 160, stone: 160, mythril: 10, clay: 60, goldCoins: 6 },
    supportedTerrains: ["Hills", "River", "Forest", "Ancient Grove"],
    blueprintTier: "apex",
  ...
  // Large Fishman's Wharf
  {
    ...
    type: "production",
    icon: "🐟",
    produces: { fish: 30, crabMeat: 6 },
    cost: { logs: 160, stone: 120, clay: 60, goldCoins: 4 },
    supportedTerrains: ["Ocean", "River", "Deep Ocean"],
    blueprintTier: "library",
  ...
  // Fishman's Wharf of the Gods
  {
    ...
    type: "production",
    icon: "🐟",
    produces: { fish: 50, crabMeat: 18, leviathanSteak: 4 },
    cost: { logs: 210, stone: 160, clay: 90, goldCoins: 10, magicalEssence: 2 },
    supportedTerrains: ["Ocean", "River", "Deep Ocean"],
    blueprintTier: "apex",
  ...
  // Evergarden
  {
    ...
    cost: { logs: 200, stone: 80, meadowheartOpal: 5, goldCoins: 6 },
  ...
  // Queen's Dock
  {
    ...
    cost: { logs: 220, stone: 160, clay: 90, goldCoins: 12, magicalEssence: 4 },
    supportedTerrains: ["Ocean", "River", "Deep Ocean"],
    blueprintTier: "ultra",
    waterAccess: true,
  },
  ...
  },
  {
    ...
    type: "production",
    icon: "🏗️",
    produces: { stone: 250, mythril: 50, meadowheartOpal: 50, goldCoins: 25, silktoneObsidian: 20, lumenQuartz: 20, starpetalOre: 2, gold: 100 },
  ...
  },
  {
    ...
    icon: "⛲",
    happinessBonus: 4,
    cost: { stone: 40, clay: 20, mythril: 2, goldCoins: 4 },
    blueprintTier: "library",
  },
  {
    key: "banner",
    ...
    icon: "🚩",
    happinessBonus: 2,
    cost: { logs: 10, clay: 5, goldCoins: 2 },
    blueprintTier: "default",
  },
