export const beastCatalog = [
  ...
  { type: "Forest Alpha", strength: 3, health: 100, rewards: { meat: 5, herbs: 6, logs: 8, magicalEssence: 10 } },
  ...
  { type: "Sea Serpent", strength: 5, health: 150, rewards: { fish: 10, lumenQuartz: 1, magicalEssence: 10 } },
  { type: "Deep Leviathan", strength: 7, health: 200, rewards: { fish: 12, lumenQuartz: 3, magicalEssence: 10 } },
  { type: "Crystal Wyrm", strength: 5, health: 160, rewards: { lumenQuartz: 4, meadowheartOpal: 2, magicalEssence: 10 } },
  { type: "Grove Guardian", strength: 4, health: 130, rewards: { herbs: 8, fruits: 6, meadowheartOpal: 1, magicalEssence: 10 } },
